...
- (void)loadStory:(void (^)(NSArray *pools))completion {
    ...
    void(^completionHandler)(NSURLResponse *response, NSData *data, NSError *connectionError) = ^(NSURLResponse *response, NSData *data, NSError *connectionError){
        ...
        if(!error){
            self.successText = dict[@"story_success"];
...
- (void)setupFromData:(NSDictionary *)data {
    ...
    self.successText      = data[@"story_success"];
}
...
+ (NSString *)dummyStoriesJSON {
    return @"{\"stories\":[{\"story_id\":\"EEB35275-91AF-49C3-80A5-7D2BE5B213D6\",\"story_name\":\"Waldi ist weg!\",\"story_description\":\"Waldi ist weg.\\nWaldi ist kein Hund.\\nWaldi wird gesucht.\",\"story_trailer\":\"trailer.mp4\",\"story_img\":\"story-1.jpeg\"},{\"story_id\":\"1067156D-23DC-40E7-8371-EEBDF71ED266\",\"story_name\":\"25 Jahre Mauerfall\",\"story_description\":\"Seit 25 Jahren ist Berlin mauerfrei. Erforsche die Gesichter entlang der Berliner Mauer.\",\"story_trailer\":\"history.mp4\",\"story_img\":\"story-5.jpeg\"},{\"story_id\":\"7CC52B11-5761-49BB-B9E5-D990F00A1A9E\",\"story_name\":\"TV Hackslay\",\"story_description\":\"Nach einer Zombie Apokalypse wurden die lokalen Rundfunkanstalten von hirnlosen Zombies übernommen. Besteht noch Hoffnung das Staffelfinale deiner Lieblingssoap zu sehen?\",\"story_trailer\":\"horror.mp4\",\"story_img\":\"story-4.jpeg\"},{\"story_id\":\"9D5EDCE5-9B98-4935-A6C9-D76D3EA431C3\",\"story_name\":\"Meat Love\",\"story_description\":\"Alice liebt Bob, doch Bob scheint nur seinen Grill im Kopf zu haben. Liebt Bob sein Grillfleisch mehr als Alice? Finde es heraus, in einer brutzeligen Schnitzeljagd.\",\"story_trailer\":\"love.mp4\",\"story_img\":\"story-3.jpeg\"}]}";
}

+ (NSString *)dummyPoolsJSON{
    return @"{\"story_id\":\"EEB35275-91AF-49C3-80A5-7D2BE5B213D6\",\"story_name\":\"Waldi ist weg!\",\"story_description\":\"Waldi ist weg.\\nWaldi ist kein Hund.\\nWaldi wird gesucht.\",\"story_trailer\":\"trailer.mp4\",\"story_img\":\"story-1.jpeg\",\"story_success\":\"Danke Kommissar! Du hast Waldi gefunden. Möge er in Frieden ruhen.\",\"pools\":[{\"pool_id\":\"CEF32CC4-CDAF-4A29-8F92-F6DCF6FA9FAF\",\"pool_sequence_nr\":1,\"transition_text\":\"Waldi ist weg. Finde heraus, was mit ihm passiert ist. Waldi wurde auf der Arbeit zuletzt gesehen. Entscheide, welchen Ort du zuerst besuchst.\",\"videos\":[\"7F904B4B-A22E-45AD-BD06-333A57032F1D\",\"1370F345-0F82-4E88-8330-76D6B26F4735\"]},{\"pool_id\":\"B4816440-530A-4B6E-8DEC-5E799CC283E5\",\"pool_sequence_nr\":2,\"transition_text\":\"Waldi wird bereits vermisst. Und es gibt einen Verdächtigen. Von einem Augenzeugen hast du den Tipp bekommen, zur Brücke zu gehen. Dort soll es weitere Hinweise geben.\",\"videos\":[\"2CABD140-FC24-4B88-9640-4A9CF910A713\"]}],\"videos\":[{\"video_id\":\"7F904B4B-A22E-45AD-BD06-333A57032F1D\",\"video_name\":\"Storywalk1.mp4\",\"video_url\":\"Storywalk1.mp4\"},{\"video_id\":\"1370F345-0F82-4E88-8330-76D6B26F4735\",\"video_name\":\"Storywalk2.mp4\",\"video_url\":\"Storywalk2.mp4\"},{\"video_id\":\"2CABD140-FC24-4B88-9640-4A9CF910A713\",\"video_name\":\"Storywalk3.mp4\",\"video_url\":\"Storywalk3.mp4\"}],\"places\":[{\"place_id\":\"8BDF6643-726F-4D0B-BE32-06DE95C6670B\",\"place_name\":\"Weg nach Hause\",\"beacon_id\":\"B9407F30-F5F8-466E-AFF9-25556B57FE6D\",\"beacon_major\":7168,\"beacon_minor\":62820,\"beacon_factor\":1,\"video\":\"7F904B4B-A22E-45AD-BD06-333A57032F1D\"},{\"place_id\":\"A9F3DF29-6D52-4B5A-B0AA-77BC95C4EA8C\",\"place_name\":\"Arbeit\",\"beacon_id\":\"B9407F30-F5F8-466E-AFF9-25556B57FE6D\",\"beacon_major\":52038,\"beacon_minor\":11119,\"beacon_factor\":1,\"video\":\"1370F345-0F82-4E88-8330-76D6B26F4735\"},{\"place_id\":\"D17265C1-80E0-451D-AFAA-7F11DE478C72\",\"place_name\":\"Waldis Schicksal\",\"beacon_id\":\"8492E75F-4FD6-469D-B132-043FE94921D8\",\"beacon_major\":1862,\"beacon_minor\":1265,\"beacon_factor\":0.7,\"video\":\"2CABD140-FC24-4B88-9640-4A9CF910A713\"}]}";
}
